...
import SustainableScreen from "../components/SustainableScreen";
...
export default function App() {
  ...
  return (
    <MainDiv>
      ...
      {screen2 ? <VolunteerScreen /> : null}
      {screen3 ? <SustainableScreen /> : null}
      {screen4 ? <EsgScreen /> : null}
      {screen5 ? <PolicyScreen /> : null}
      {screen6 ? <NetworkScreen /> : null}
    </MainDiv>
  );
}
